    ...
    >
      <div className="help-card">
        ...
        <div className="help-list" role="list">
          ...
          <div role="listitem"><span>wager</span><strong>USDC margin &mdash; your max loss</strong></div>
          <div role="listitem"><span>jump</span><strong>opens a leveraged long on Avantis</strong></div>
          <div role="listitem"><span>rise</span><strong>1% ETH up &times; boost = % gain on wager</strong></div>
          <div role="listitem"><span>fall</span><strong>1% ETH down &times; boost = % loss on wager</strong></div>
